...
<div class="form-group col-lg-6 col-sm-6">
    ...
    <input type="text" class="form-control time campoHora" id="horaInicio" name="horaInicio" placeholder="hh:mm" value="<t:time time="${usuario.horaInicio}"/>" >
...
<div class="form-group col-lg-6 col-sm-6">
    ...
    <input type="text" class="form-control time campoHora" id="horaFim" name="horaFim" placeholder="hh:mm" value="<t:time time="${usuario.horaFim}"/>">

...
public class ServicoDAO implements BaseDAO<Servico>{
    ...
    @Override
    public void create(Connection conn, Servico e) throws Exception {
    ...
    @Override
    public Servico readById(Connection conn, Long id) throws Exception {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<Servico> readByCriteria(Connection conn, Map<String, Object> criteria, Integer offset) throws Exception {
    ...
    @Override
    public void update(Connection conn, Servico e) throws Exception {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
